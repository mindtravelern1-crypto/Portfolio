      ...
      <div style={{
        ...
        <div style={{ position: "relative", zIndex: 2 }}>
          ...
          <div style={{
            ...
            <span style={{ ...T.mono, color: C.ghost, fontSize: "0.6rem" }}>·</span>
            {/* 年份 */}
            <span style={{ ...T.mono, color: C.faint, fontSize: "0.7rem" }}>{work.year}</span>
            <span style={{ ...T.mono, color: C.ghost, fontSize: "0.6rem" }}>·</span>
            {/* 細項 */}
            <span style={{ ...T.label, color: C.ghost, fontSize: "0.58rem" }}>{work.type}</span>
            <span style={{ ...T.mono, color: C.ghost, fontSize: "0.6rem" }}>·</span>
            {/* 狀態 */}
      ...
      <div style={{
        ...
        <article style={{ minWidth: 0 }}>
          ...
          <div style={{
            ...
            borderTop: `1px solid ${C.hairBold}`,
          }}>
    ...
    return (
      <section
        ...
        style={{
          paddingTop: "3.5rem",
          marginBottom: "3.5rem",
          borderTop: idx === 0 ? "none" : `1px solid ${C.hairBold}`,
        }}>
          ...
          {ch.frameworks.map((f, i) => (
            <div key={i} style={{
              ...
              <h4 style={{
                ...T.h4,
                fontSize: "0.98rem",
                color: C.ink, margin: "0 0 0.55rem",
                fontWeight: 500,
                letterSpacing: "-0.005em",
              }}>{f.name}</h4>
              <p style={{ ...T.bodyS, color: C.mid, margin: 0, fontSize: "0.88rem" }}>
                {f.desc}
              </p>
            </div>
          ))}
      ...
      <section
        ...
        <div style={{ marginTop: "2.5rem" }}>
          {ch.decisions.map((d, i) => (
            <div key={i} style={{
              display: "grid",
              gridTemplateColumns: "36px 1fr 1.2fr",
              gap: "2rem",
              padding: "2rem 0",
              borderBottom: `1px solid ${C.hair}`,
              opacity: inView ? 1 : 0,
              ...
              <span style={{ ...T.mono, color: C.faint, fontSize: "0.82rem", paddingTop: "0.25rem", fontWeight: 500 }}>
                {String(i + 1).padStart(2, "0")}
              </span>
              <h4 style={{
                ...T.h4,
...
const ChapterHeader = ({ ch, inView }) => (
  <header style={{
    ...
    <span style={{
      ...T.mono, color: C.ink, fontSize: "1.1rem", fontWeight: 500,
      opacity: inView ? 1 : 0,
